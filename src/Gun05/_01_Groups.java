...
public class _01_Groups {
    ...
    @Test(groups = "SmokeTest") //smoke test-->duman test(ilk bakis testi,en genel itibari ile yapilan test)
    void Test1() {
        System.out.println("Test 1 SmokeTest");
    }

    @Test(groups = "Regression")//Regression-->tum sistemin kontrol edildigi test
    void Test3() {
